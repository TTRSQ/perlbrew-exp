...
XS_EUPXS(XS_Storable_init_perinterp)
{
    ...
    if (items != 0)
       croak_xs_usage(cv,  "");
    {
#line 7830 "Storable.xs"
    init_perinterp(aTHX);
#line 7968 "Storable.c"
    }
    XSRETURN_EMPTY;
}
...
#line 7882 "Storable.xs"
    RETVAL = pretrieve(aTHX_ f, flag);
#line 8045 "Storable.c"
	RETVAL = sv_2mortal(RETVAL);
	ST(0) = RETVAL;
    }
    XSRETURN(1);
...
;
	SV *	RETVAL;
#line 7899 "Storable.xs"
    RETVAL = dclone(aTHX_ sv);
#line 8093 "Storable.c"
	RETVAL = sv_2mortal(RETVAL);
	ST(0) = RETVAL;
    }
    XSRETURN(1);
...
XS_EUPXS(XS_Storable_last_op_in_netorder)
{
    ...
    if (items != 0)
       croak_xs_usage(cv,  "");
    {
#line 7909 "Storable.xs"
    bool result;
#line 8111 "Storable.c"
#line 7911 "Storable.xs"
    if (ix) {
        dSTCXT;
        assert(cxt);
