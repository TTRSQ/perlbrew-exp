...
"x86_64-linux-4.15.0-1006-gcp" or
	die "Errno architecture (x86_64-linux-4.15.0-1006-gcp) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
