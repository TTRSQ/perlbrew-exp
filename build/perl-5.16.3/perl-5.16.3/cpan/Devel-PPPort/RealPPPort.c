...
XS_EUPXS(XS_Devel__PPPort_newRV_inc_REFCNT)
{
    ...
    if (items != 0)
       croak_xs_usage(cv,  "");
    {
#line 317 "RealPPPort.xs"
		SV *sv, *rv;
#line 471 "RealPPPort.c"
	U32	RETVAL;
	dXSTARG;
